...
class TestSGEntity(BaseShotGridTest):
    ...
    def test_get(self):
        ...
        self.assertEqual({'code': 'Test Project', 'tank_name': 'tp'},
    ...
    def test_fields(self):
        ...
        self.assertEqual({'linux_path', 'type', 'id', 'description', 'cached_display_name',
                          'mac_path', 'created_by', 'updated_by', 'created_at', 'windows_path',
                          'uuid', 'code', 'updated_at'},
    ...
    def test_schema(self):
        ...
        self.assertEqual({'name': {'editable': False, 'value': 'Project'},
    ...
    def test_field_schemas(self):
        ...
        self.assertEqual('Tank Name', sg_entity.field_schemas()['tank_name']['name']['value'])

    def test_batch_update_dict(self):
        sg_entity = pysg.SGEntity(self.sg, 'Project', 1)

        self.assertEqual({'data': {'code': 'foo', 'tank_name': 'bar'},
                          'entity_id': 1,
                          'entity_type': 'Project',
                          'request_type': 'update'},
