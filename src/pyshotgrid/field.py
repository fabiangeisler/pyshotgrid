...
class MultiEntityField(BaseField):
    """
    This class represents a Multi Entity field in ShotGrid.
    """
...
class UrlFileLinkField(BaseField):
    """
    This class represents a URL/File/Link field in ShotGrid.
    """
